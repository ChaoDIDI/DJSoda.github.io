webpackJsonp([27, 40], [function (t, n, e) {
    "use strict";
    e(346);
    var i = e(347), r = e(88), o = e(348), a = e(349), s = e(350), u = e(351), c = e(352), l = {
        init: function () {
            var t = u() + o() + a() + s();
    ...
    t.exports = function (t, n, e, w, _, y, x) {
        c(e, n, w);
        ...
        if (F && (S = f(F.call(new t)), S !== Object.prototype && (l(S, P, !0), i || s(S, d) || a(S, d, g))), M && j && j.name !== m && ($ = !0, E = function () {
                return j.call(this)
            }), i && !x || !p && !$ && I[d] || a(I, d, E), u[n] = E, u[P] = g, _)if (b = {
                values: M ? E : O(m),
                keys: y ? E : O(v),
                entries: C
            }, x)for (k in b)k in I || o(I, k, b[k]); else r(r.P + r.F * (p || $), n, b);
        return b
    }
}, function (t, n) {
    t.exports = !0
    ...
    var i = e(20), r = e(35), o = e(29), a = e(19), s = e(34), u = e(65).KEY, c = e(30), l = e(49), f = e(53), d = e(50), p = e(54), h = e(61), v = e(66), m = e(67), g = e(68), w = e(71), _ = e(26), y = e(42), x = e(32), b = e(33), k = e(38), S = e(72), O = e(74), P = e(25), M = e(40), $ = O.f, I = P.f, j = S.f, E = i.Symbol, C = i.JSON, F = C && C.stringify, T = "prototype", U = p("_hidden"), A = p("toPrimitive"), N = {}.propertyIsEnumerable, D = l("symbol-registry"), L = l("symbols"), q = l("op-symbols"), R = Object[T], H = "function" == typeof E, W = i.QObject, z = !W || !W[T] || !W[T].findChild, J = o && c(function () {
        ...
        return t === R && B(q, n, e), _(t), n = x(n, !0), _(e), r(L, n) ? (e.enumerable ? (r(t, U) && t[U][n] && (t[U][n] = !1), e = k(e, {enumerable: b(0, !1)})) : (r(t, U) || I(t, U, b(1, {})), t[U][n] = !0), J(t, n, e)) : I(t, n, e)
    }, G = function (t, n) {
        _(t);
        ...
        if (t = y(t), n = x(n, !0), t !== R || !r(L, n) || r(q, n)) {
            var e = $(t, n);
    ...
    H || (E = function () {
        ...
        var t = d(arguments.length > 0 ? arguments[0] : void 0), n = function (e) {
            this === R && n.call(q, e), r(this, U) && r(this[U], t) && (this[U][t] = !1), J(this, t, b(1, e))
        };
    ...
    var r = e(83), o = i(r), a = e(87), s = e(88), u = e(89), c = e(9), l = e(90), f = e(91), d = l.inviteJoinMoney, p = {
        init: function () {
            1 == s() && (this.nickname, this.headImgUrl, this.thumbUrl = "http://static-59729941.mtmssdn0.com/img/share_logo2.png", this.description = "。", this.uri = window.location.href, this._setParams())
        }, _getRandomTitle: function (t, n) {
            var e = t + "邀请你加入民意互助，最高享45万健康保障。";
            return e
            ...
            if (this.uri.indexOf("list/") > -1)n = {
                title: "我加入了民意互助，一瓶水的钱在关键时刻能帮上大忙！",
                ...
                i = {
                    ...
                    description: "民意互助抵御风险社群，已有超100万用户加入。"
    ...
    var e = {
        ...
        introVideo: {name: "了解民意视频链接", url: "http://v.qq.com/x/page/c0313d2ppk0.html"}
    };
    t.exports = e
}, , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , function (t, n, e) {
    ...
    t.exports = (i["default"] || i).template({
        compiler: [7, ">= 4.0.0"], main: function (t, n, e, i, r) {
            return '<div class="service-guarantee"></div>  \n'
        }, useData: !0
    })
}, function (t, n, e) {
    var i = e(198);
    t.exports = (i["default"] || i).template({
        compiler: [7, ">= 4.0.0"], main: function (t, n, e, i, r) {
            return '\n  <h1>媒体报道</h1>\n  <div class="report-img"><img src="../comprehensive/首页09.png" alt="" style="width: 95%;margin-left: 15px"></div>'
        }, useData: !0
    })
}, function (t, n, e) {
    var i = e(198);
    t.exports = (i["default"] || i).template({
        compiler: [7, ">= 4.0.0"], main: function (t, n, e, i, r) {
            return '<div class="plan-question">\n  <h1>常见问题</h1>\n  <ul>\n    <li class="question-pose" trackEvent trackLabel="意外计划问题1点击">Q1 意外互助范围是什么？什么才算意外？<i class="question-arrow"></i>\n      <!--(1)弹出内容-->\n      <div class="hidden-content">\n        <em></em>\n        <p class="tabFonts">“意外”需同时满足外来的、突发的、非本意的和非疾病的四个要素，符合此要求造成的身体伤残才可以在本计划中获得互助哦。</p>\n        <p class="tabFonts">会员遭受意外伤害，并自该意外伤害发生之日起两百七十日内因该意外伤害导致身故或者身残的，其亲属或本人可发起求助申请。</p>\n        <p class="tabFonts">其中意外伤残的标准以中国保险行业协会和中国法医学会在2013年6月联合发布的《人身保险伤残评定标准》对应的伤残等级，按比例进行互助。\n        </p>\n      </div>\n    </li>\n    <li class="question-pose" trackEvent trackLabel="意外计划问题2点击">Q2 若遇不幸怎么申请互助？<i class="question-arrow"></i>\n      <!--(2)弹出内容-->\n      <div class="hidden-content">\n        <em></em>\n        <p>如果不幸发生意外，可按照以下流程申请互助</p>\n        <p class="qus-two">（1）拨打客服电话400-995-5780发起申请；\n          <br> （2）第三方专业公估机构核实后，全平台公示；\n          <br> （3）公示通过无异议，从互助金中划款。\n        </p>\n        <p class="qus-two">以“我的民意”页面中已加入的计划为凭证。</p>\n      </div>\n    </li>\n    <li class="question-pose" trackEvent trackLabel="意外计划问题3点击">Q3 我已经有了意外险为什么也该加入？<i class="question-arrow"></i>\n      <!--(3)弹出内容-->\n      <div class="hidden-content">\n        <em></em>\n        <p class="tabFonts">综合意外计划互助计划和意外险不互斥，可同时享有，相互补充。且对于很多意外险不予报销的开支，可以通过综合意外计划互助计划来报销。双重保障，为您的健康保驾护航。</p>\n      </div>\n    </li>\n    <li class="question-pose" trackEvent trackLabel="意外计划问题4点击">Q4 民意互助是保险吗？<i class="question-arrow"></i>\n      <!--(4)弹出内容-->\n      <div class="hidden-content">\n        <em></em>\n        <p class="tabFonts">民意互助是互助社群，不是保险。加入民意互助，一人患病，众人分摊，大家互帮互助。且民意互助不赚取提成费用，保证每一分钱都只用于互助，与保险有本质区别。</p>\n      </div>\n    </li>\n  </ul>\n</div>\n<div class="qus-tel">\n  <div class="que-tel-line">\n    <a class="tel-question" href="tel:4009955780"><em class="tel-one"></em><span>电话咨询</span></a>\n    <a class="wx-question" href="javascript:;"> <em class="wx-one"></em><span>微信咨询</span></a>\n  </div>\n</div>\n'
        }, useData: !0
    })
}, function (t, n, e) {
    var i = e(198);
    t.exports = (i["default"] || i).template({
        compiler: [7, ">= 4.0.0"], main: function (t, n, e, i, r) {
            return '<div class="help-rule">\n      <h1>互助规则</h1>\n      <ul>\n        <li class="plan-people li-border-bottom">保障人群\n          <span>1-65周岁，身体健康</span>\n          <i class="arrow"></i>\n        </li>\n        <div class="hidden-ctn">\n          <section id="planPeople" class="plan-info-msg">\n             <em></em>\n            <p class="font-one">为保证公平性，加入者须满足以下条件：</p>\n            <p class="font-one">1.年龄1至65周岁（年满66周岁自动退出计划）。</p>\n            <p class="font-one">2.身体健康，能正常工作，无肢体运动功能或躯体感觉障碍，无器官移植史。</p>\n            <p class="font-one">3.非港澳台居民。</p>\n            <p class="font-one">4.符合《健康及职业要求》中的规定。</p>\n            <p class="font-one">5.认同并承诺遵守《会员公约》以及本互助计划规则。</p>\n        </section>\n        </div>\n\n        <li class="plan-cover li-border-bottom">保障范围\n          <span>意外身故和意外伤残</span>\n          <i class="arrow"></i>\n        </li>\n         <div class="hidden-ctn">\n          <section id="planCover" class="plan-info-msg">\n             <em></em>\n            <p class="font-one">意外身故：遭受意外事故，且自事故发生之日起270日内因同一原因身故的（不包括猝死）</p>\n            <p class="font-one">意外伤残：遭受意外事故，并自该意外伤害发生之日起270日内因同一原因导致身体伤残的</p>\n    \n          </section>\n        </div>\n\n        <li class="plan-num li-border-bottom">保障额度\n          <span>最高<em>45万元</em>保障</span>\n          <i class="arrow"></i>\n        </li>\n        <div class="hidden-ctn">\n          <section id="planNum" class="plan-info-msg">\n             <em></em>\n           <table class="plan-table accident-table">\n             <tr>\n             <th>项目</th>\n             <th>最高互助金</th>\n             </tr>\n             <tr>\n                <td>身故互助金</td>\n                <td>45万元</td>\n                </tr>\n                <tr>\n                <td>伤残互助金</td>\n                <td>按《人身保险伤残评定标准》规定的比例给付，累计最高：45万元</td>\n                </tr>\n           </table>\n          </section>          \n        </div>\n        <li class="plan-rule li-border-bottom">分摊规则\n          <span>单次不超过<em>3元</em>，每年约<em>50元</em></span>\n          <i class="arrow"></i>\n        </li>\n        <div class="hidden-ctn">\n          <section id="planRule" class="plan-info-msg">\n             <em></em>\n            <p class="font-one font-bottom">如有会员不幸发生意外，其他会员会均摊帮助，单次均摊不超过3元。</p>\n           <table class="plan-table">\n             <tr>\n             <th>会员总数</th>\n             <th>均摊金额</th>\n             <th>互助金</th>\n             </tr>\n              <tr>\n                <td>5万人</td>\n                <td>2.0元</td>\n                <td>10万元</td>\n                </tr>\n             <tr>\n                <td>10万人</td>\n                <td>1.0元</td>\n                <td>10万元</td>\n                </tr>\n                <tr>\n                <td>50万人</td>\n                <td>0.2元</td>\n                <td>10万元</td>\n                </tr>\n                <tr>\n                <td>100万人</td>\n                <td>0.1元</td>\n                <td>10万元</td>\n                </tr>\n           </table>\n           <p class="font-one">说明：</p>\n           <p class="font-one">(1) 如上表，会员数量越多，单次分摊金额越低。</p>\n           <p class="font-one">(2) 会员账户余额归本人所有，只有发生互助时才会扣除相应金额。</p>\n          </section>          \n        </div>\n        <li class="plan-continue li-border-bottom">保障延续\n          <span>账户余额不低于19元即可</span>\n          <i class="arrow"></i>\n        </li>\n        <div class="hidden-ctn">\n          <section id="planContinue" class="plan-info-msg">\n             <em></em>\n            <p class="font-one font-bottom">为保障会员能及时获得互助保障金，每人的账户余额不得低于19元。</p>\n           <table class="plan-table">\n             <tr>\n             <th class="th-one">余额</th>\n             <th>保障状态</th>\n             <th>余额状态</th>\n             </tr>\n             <tr>\n                <td>余额≥30元</td>\n                <td><i class="yes-icon"></i></td>\n                <td class="continue-left">充足</td>\n                </tr>\n                <tr>\n                <td>19元≤余额<30元</td>\n                <td><i class="yes-icon"></i></td>\n                <td class="continue-left">良，建议充值至50元以上，避免频繁充值</td>\n                </tr>\n                <tr>\n                <td>1元≤余额<19元</td>\n                <td><i class="yes-icon"></i></td>\n                <td class="continue-left">不足，建议及时充值，以免因余额不足失去保障</td>\n                </tr>\n                <tr>\n                <td>余额< 19元</td>\n                <td><i class="no-icon"></i></td>\n                <td class="continue-left">暂时失去保障，您可以在15天内充值以恢复保障，否则将自动退出</td>\n                </tr>\n           </table>\n           <p class="font-one">说明：</p>\n           <p class="font-one">(1) 余额低于19元时，我们会通过微信或短信提醒充值。</p>\n           <p class="font-one">(2) 互助金由基金会独立托管并定期公示。</p>\n          </section>          \n        </div>\n        <li class="plan-wait li-border-bottom">等待期\n          <span class="wait-font">270天</span>\n          <i class="arrow"></i>\n        </li>\n        <div class="hidden-ctn">\n          <section id="waitTime" class="plan-info-msg">\n             <em></em>\n            <p class="wait-font font-one">设置等待期的目的是为了防止一些故意的、非正常的行为，导致发生损害广大互助群体利益的情况。</p>\n            <p class="font-one">在等待期内，若发生意外不可以申请互助金，但须履行分摊义务。等待期过后，会员如不幸发生意外，本计划下的其他互助会员为其发起互助。</p>\n          </section>          \n        </div>\n      </ul>\n    </div>\n'
        }, useData: !0
    })
}, function (t, n, e) {
    var i = e(198);
