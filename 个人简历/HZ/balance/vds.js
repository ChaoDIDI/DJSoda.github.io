!function t(e, r, n) {
    ...
    1: [function (t, e, r) {
        ...
        function l(t) {
            return A ? A : (A = c(k), A.oldValue = t, A)
        }
        ...
        var O = new w, C = window.msSetImmediate;
        if (!C) {
            var N = [], x = String(Math.random());
        ...
        v.prototype = {
            enqueue: function (t) {
                ...
                this.transientObservedNodes = [], t.forEach(function (t) {
                    ...
                    for (var e = O.get(t), r = 0; r < e.length; r++)if (e[r] === this) {
                        e.splice(r, 1);
                        break
                    }
                }, this)
        ...
        var h = function () {
            ...
            return t.prototype.processMutations = function () {
                ...
                for (var o = {}, a = this.treeChanges.keys(), n = 0; n < a.length; n++) {
                    ...
                    if (u.attributes && 2 === this.treeChanges.reachabilityChange(s) && 2 === this.matchabilityChange(s))for (var d = s, c = u.getAttributeNamesMutated(), h = 0; h < c.length; h++) {
                        var i = c[h];
            ...
            return Object.defineProperty(t.prototype, "caseInsensitiveTagName", {
                ...
                for (var i, o, a, s = [], u = /\s/, d = "Invalid or unsupported selector syntax.", c = 1, h = 2, l = 3, f = 4, p = 5, g = 6, b = 7, y = 8, O = 9, C = 10, N = 11, x = 12, S = 13, I = 14, E = c, k = 0; k < e.length;) {
                    var A = e[k++];
                    switch (E) {
                        case c:
                            if (A.match(v)) {
                            ...
                            if ("." == A) {
                                r(), n(), i.tagName = "*", o.attrName = "class", o.contains = !0, E = f;
                                break
                            }
                            if ("#" == A) {
                                r(), n(), i.tagName = "*", o.attrName = "id", E = f;
                                break
                            }
                            if ("[" == A) {
                        ...
                        case h:
                            ...
                            if ("." == A) {
                                n(), o.attrName = "class", o.contains = !0, E = f;
                                break
                            }
                            if ("#" == A) {
                                n(), o.attrName = "id", E = f;
    ...
    3: [function (t, e, r) {
        ...
        u = t("./utils"), a = u.detectIE() || 0 / 0, 9 > a ? t("json2") : (window.MutationObserver = t("mutation-observer"), o = t("tree-mirror")), s = t("./info"), u = t("./utils"), i = t("./messaging_observer"), n = function () {
            ...
            var e, r, n, a, c, h, l, f, p, g, v, m, w, b, y, O, C, N, x;
            return a = null, x = "0.56", y = 3, h = [], r = {}, c = {}, f = {}, C = null, l = null, O = null, n = !0, N = {
                tspan: 1,
                text: 1,
                g: 1,
                rect: 1,
                ...
                desc: 1,
                title: 1
            }, e = ["TEXTAREA", "HTML", "BODY"], w = ["button", "submit"], b = ["A", "BUTTON", "INPUT", "IMG"], g = ["I", "SPAN", "EM"], m = ["A", "BUTTON"], v = m, p = ["radio", "checkbox"], t.prototype.setPageGroup = function (t) {
                ...
                var t;
                if (window.vds.imp)return null != a && a.disconnect(), t = {
                        ...
                        return function (e, r, n, i) {
                            ...
                            if (r.length > 0 && !document.body.className.match(/\bvds-entrytext\b/)) {
                                for (t.gruser.hasSid() || (t.pageLoaded = +Date.now(), t.trackPageView(2)), u = {
                                    ...
                                    d: window.location.host || window.vds.accountId,
                                    p: t.currentPath
                                }, t.currentQuery.length > 0 && (u.q = t.currentQuery), o = [], a = 0, s = r.length; s > a; a++)d = r[a], o = o.concat(t.getLeafNodes(d, d.length));
                                if (u.e = o, o.length > 0)return h.push(u), 0 > y ? t.sendQueue() : (t.queueTimeout && clearTimeout(t.queueTimeout), t.queueTimeout = setTimeout(function () {
                                    return t.sendQueue()
                ...
                var r, n, i, o, a, s, d, c, h;
                if (i = [], s = !0, t.leaf)1 === t.nodeType && ((null != (d = t.attributes) ? d.href : void 0) || null != t.text) && (a = this.nodeMessage(t, !0), e > 1 && (a.idx = t.idx), i.push(a)); else if (0 === t.childNodes.length && -1 === u.indexOf(b, t.tagName)); else {
                    for (c = t.childNodes, n = 0, o = c.length; o > n; n++)r = c[n], r.leaf || (s = !1), i = i.concat(this.getLeafNodes(r, t.childNodes.length));
                    s && (null != (h = t.attributes) ? h.any : void 0) && (t.text || (t.text = u.parentOfLeafText(t)), t.childNodes.length > 0 && t.childNodes[0].idx && -1 === u.indexOf(["TABLE", "TBODY", "UL", "OL"], t.tagName) && (t.idx = t.childNodes[0].idx),
                        a = this.nodeMessage(t, !1), i.push(a))
                }
                return i
            }, t.prototype.nodeMessage = function (t, e) {
                var r, n, i, o, a, s, d;
                return i = {x: t.path}, (null != (a = t.text) ? a.length : void 0) > 0 ? i.v = null != (s = t.text) ? s.slice(0, 50) : void 0 : e || 0 !== (null != (d = t.text) ? d.length : void 0) || -1 === u.indexOf(m, t.tagName) || (n = t.dom, n && (null != n.textContent ? o = n.textContent.trim() : null != n.innerText && (o = n.innerText.trim()), o && o.length > 0 && o.length < 50 && (i.v = o))), (r = t.attributes) && r.href && 0 !== r.href.indexOf("javascript") && (i.h = u.normalizePath(r.href.slice(0, 320)), delete t.attributes.href), t.idx && (i.idx = t.idx), i
            }, t.prototype.registerEventListener = function () {
                var t, r, i, o, a, d, c, h, y, x;
                d = {
                    click: "clck",
                    change: "chng",
                    submit: "sbmt"
                    ...
                    return t.which > 1 || (O = +Date.now(), l === O) ? void 0 : (l = O, f = {
                        ...
                        return t = {target: f.target, type: "click"}, a(t)
                    }, 600))
                }, h = function (t) {
                    var e;
                    return e = {
                    ...
                    }, e.adx > 10 || e.ady > 10 ? clearTimeout(C) : void 0
                }, x = function (t) {
                    var e;
                    return e = +Date.now() - f.time, 1e3 > e ? clearTimeout(C) : void 0
                }, c = function (t, e) {
                    var r;
                    return r = n ? e.touches[0] : e, r["page" + t.toUpperCase()]
                }, i = function () {
                    var t, e, i, o, a, s, u, d, c, l, f, p, g, v;
                    v = navigator.userAgent, o = /chrome/i.exec(v), i = /android/i.exec(v), n = "ontouchstart" in window && !(o && !i), p = n ? ["touchstart"] : ["mousedown"], g = n ? ["touchend", "touchcancel"] : ["mouseup", "mouseleave"], l = n ? ["touchmove"] : ["mousemove"];
                    for (e = 0, u = p.length; u > e; e++)t = p[e], r(document, t, y);
                    for (a = 0, d = l.length; d > a; a++)t = l[a], r(document, t, h);
                    for (f = [], s = 0, c = g.length; c > s; s++)t = g[s], f.push(r(document, t, x));
                    return f
                }, a = function (t) {
                    return function (r) {
                        var n, i, o, a, c, h, l, f, y, O, C, x, S, I, E;
                        if (!document.body.className.match(/\bvds-entrytext\b/)) {
                            for (t.lastActionTime = +Date.now(), I = r.target || r.srcElement; I && 1 === N[I.tagName] && I.parentNode;)I = I.parentNode;
                            if (-1 !== u.indexOf(g, I.tagName) && I.parentNode && -1 !== u.indexOf(m, I.parentNode.tagName) && (I = I.parentNode), n = s.path(I, !0), n.isIgnore)return;
                            if (S = I.tagName, "click" === r.type) {
                                if (-1 !== u.indexOf(e, S))return;
                                if ("INPUT" === S && -1 === u.indexOf(w, I.type))return;
                                if (-1 === u.indexOf(b, S) && !s.depthInside(I, 4))return
                            }
                            if (t.gruser.hasSid() || (t.pageLoaded = +Date.now(), t.trackPageView(2)), y = {}, y.u = t.gruser.vid(), y.s = t.gruser.sid(), y.t = d[r.type], y.tm = +Date.now(), y.ptm = t.pageLoaded, y.d = window.location.host || window.vds.accountId, y.p = t.currentPath, t.currentQuery.length > 0 && (y.q = t.currentQuery), i = {}, i.x = n.xpath, (-1 !== i.x.indexOf("/dl") || -1 !== i.x.indexOf("/tr") || -1 !== i.x.indexOf("/li")) && (i.idx = s.index(I)), u.hasAttr(I, "href") && (o = I.getAttribute("href"), o && (i.h = u.normalizePath(o.slice(0, 320)))), "click" === r.type && s.isLeaf(I))"IMG" === S ? (-1 === (null != (C = I.src) ? C.indexOf("data:image") : void 0) && (i.h = I.src), I.alt ? i.v = I.alt : i.h && (h = i.h.split("?")[0], c = h.split("/"), c.length > 0 && (i.v = c[c.length - 1]))) : "INPUT" === S ? i.v = I.value : (null != I.textContent ? (E = I.textContent.trim(), E.length > 0 && E.length < 50 && (i.v = E)) : null != I.innerText && (E = I.innerText.trim(), E.length > 0 && E.length < 50 ? i.v = E : "A" === S && (i.v = E.slice(0, 30))), i.v && 0 !== i.v.length || !u.hasAttr(i, "data-growing-title") || (i.v = i.getAttribute("data-growing-title"))); else if ("change" === r.type && "TEXTAREA" !== S && ("INPUT" === S && (-1 !== u.indexOf(p, I.type) || "password" !== I.type && u.hasAttr(I, "growing-track")) || "SELECT" === S))i.v = I.value; else if ("submit" === r.type)for (x = I.getElementsByTagName("input"), a = 0, f = x.length; f > a; a++)l = x[a], ("search" === l.type || "text" === l.type && ("q" === l.id || -1 !== l.id.indexOf("search") || -1 !== l.className.indexOf("search") || "q" === l.name || -1 !== l.name.indexOf("search"))) && (i.x = s.path(l).xpath, i.v = l.value.trim()); else"click" === r.type && s.isParentOfLeaf(I) ? -1 === u.indexOf(v, I.tagName) || s.onlyContainsChildren(I, g) ? (O = u.parentOfLeafText(I), O.length > 0 && O.length < 50 ? i.v = O : 0 === O.length && -1 !== u.indexOf(m, S) && (O = I.innerText.trim(), O.length > 0 && O.length < 50 && (i.v = O))) : i.v = s.containerElemContent(I) : "click" === r.type && -1 !== u.indexOf(v, I.tagName) && (i.v = s.containerElemContent(I));
                            return y.e = [i].concat(n.containerMessage), t.send([y])
                        }
                    }
                }(this);
                for (o in d)r(document, o, a);
                ...
                if (r.pg)for (e in r)i[e] = r[e], c[e] = r[e]; else c = {};
                ...
                var t, e;
                try {
                    if (window.self !== window.top && (e = null != window.self.name ? window.self.name : window.name, "grcw" === e))return this.messagingObserver = new i, this.messagingObserver.sendPageLoad(c)
                } catch (r) {
                    t = r
                }
    ...
    }, {"./info": 6, "./messaging_observer": 8, "./utils": 12, json2: 14, "mutation-observer": 1, "tree-mirror": 16}],
    4: [function (t, e, r) {
        var n, i;
    ...
    6: [function (t, e, r) {
        ...
        u = t("./guid"), a = t("cookie"), l = t("./utils"), o = /(^| )(clear|clearfix|active|hover|enabled|hidden|display|focus|disabled|ng-|growing-)[^\. ]*/g, s = /\.?([a-zA-Z0-9\-]+\.[a-zA-Z]{2,6})$/, i = function () {
            function t(t) {
                var e, r;
                this.node = t, this.name = t.tagName.toLowerCase(), l.hasAttr(t, "id") && null === t.getAttribute("id").match(/^[0-9]/) && (this.id = t.getAttribute("id")), this.isIgnore = l.hasAttr(t, "growing-ignore") || l.hasAttr(t, "data-growing-ignore"), l.hasAttr(t, "href") && (this.href = t.getAttribute("href")), "input" === this.name && l.hasAttr(t, "name") && t.getAttribute("name") ? this.klass = [t.getAttribute("name")] : (e = null != (r = t.getAttribute("class")) ? r.replace(o, "").trim() : void 0, (null != e ? e.length : void 0) > 0 && (this.klass = e.split(/\s+/).sort()))
            }
        ...
        }(), c = ["TR", "LI", "DL"], h = ["A", "BUTTON"], d = {
            user: function () {
                return new n
            }, path: function (t, e) {
                var r, n, o, a, s, u, d;
                if (null == e && (e = !1), a = "", s = !1, n = [], t === document)return {isIgnore: !0};
                for (r = new i(t); "body" !== r.name && "html" !== r.name;) {
                    if (u = r.path(), r.isIgnore && (s = !0), e && "" !== a && -1 !== l.indexOf(h, r.node.tagName))return o = this.path(r.node), n = {
                        x: o.xpath,
                        h: r.href,
                ...
                return {xpath: a, containerMessage: n, isIgnore: s}
            }, index: function (t) {
                var e, r, n, i, o, a, s;
                for (o = t; o && "BODY" !== o.tagName && -1 === l.indexOf(c, o.tagName);)o = o.parentNode;
                ...
                for (o = t.children, n = 0, i = o.length; i > n; n++)if (r = o[n], -1 === l.indexOf(e, r.tagName))return !1;
                return !0
    ...
    7: [function (t, e, r) {
        ...
        if (t("./shim"), i = t("./tracker"), n = t("./dom_observer"), l = new i, u = new n, o = function () {
                ...
                try {
                    if (null != l[r])return l[r].apply(l, t);
                    if (null != u[r])return u[r].apply(u, t)
                } catch (n) {
                    return e = n, console.error(e)
                }
            }, !window.vds || !window.vds.origin) {
            for (null == window._vds && (window._vds = [["setAccountId", "22222-22222-22222-22222"]]), h = window._vds, d = 0, c = h.length; c > d; d++)a = h[d], o.apply(null, a);
            window._vds = {
                push: function () {
    ...
    }, {"./dom_observer": 3, "./shim": 10, "./tracker": 11}],
    8: [function (t, e, r) {
        ...
        i = t("./utils"), n = function () {
            ...
            return t.prototype.bindEvents = function () {
                return i.bind(window, "message", function (t) {
                    return function (e) {
                        var r;
                        if (r = e.data, r.ai === window.vds.accountId && (e.origin === window.vds.origin || -1 !== i.indexOf(["www.growingio.com", "growingio.com"], e.origin.split("://")[1])))switch (e.origin !== window.vds.origin && (window.vds.origin = e.origin), r.mode) {
                            case"load-plugin":
                                return t.loadPlugin();
                            case"circle-mode":
                ...
                var t, e, r, n, i, o, a;
                for (this.pluginLoaded = !1, o = document.getElementsByTagName("script"), n = 0, i = o.length; i > n; n++)if (r = o[n], a = r.getAttribute("src"), null != a && -1 !== a.indexOf("/circle-plugin.js")) {
                    this.pluginLoaded = !0;
                    break
                }
    ...
    }, {"./gr_local_store": 4, "./utils": 12, cookie: 13}],
    10: [function (t, e, r) {
        ...
        u = t("./guid"), h = t("lzstring"), c = t("./info"), p = t("./utils"), o = t("./server_imp_setting"), d = p.detectIE() || 0 / 0, l = navigator.userAgent.match(/Chrom(e|ium)\/([0-9]+)\./), s = l ? parseInt(l[2], 10) : !1, s && 22 > s ? n = !1 : (n = !0, f = navigator.userAgent, g.call(window, "ArrayBufferView") >= 0 || (-1 !== f.indexOf("Android") ? n = !1 : -1 !== f.indexOf("CPU OS ") ? -1 !== f.indexOf("CPU OS 6_") ? n = !1 : -1 !== f.indexOf("CPU OS 5_") ? n = !1 : -1 !== f.indexOf("CPU OS 4_") ? n = !1 : -1 !== f.indexOf("CPU OS 3_") && (n = !1) : -1 !== f.indexOf("CPU iPhone OS ") ? -1 !== f.indexOf("iPhone OS 6_") ? n = !1 : -1 !== f.indexOf("iPhone OS 5_") ? n = !1 : -1 !== f.indexOf("iPhone OS 4_") && (n = !1) : -1 !== f.indexOf("Intel Mac OS X") && (-1 !== f.indexOf("Mac OS X 10_6") ? n = !1 : -1 !== f.indexOf("Mac OS X 10_7") && (n = !1)))), i = function () {
            ...
            return e = [], r = [], t.prototype.connect = function () {
                ...
                if (a = this.urlMap[e], window.grWaitTime = Date.now() + 300, window.XMLHttpRequest && 7 !== d) {
                    if (i = new XMLHttpRequest, "withCredentials" in i)return i.open("POST", a + "?stm=" + +Date.now(), !0), i.withCredentials = !0, i.onreadystatechange = function () {
                        return 4 === i.readyState ? window.grWaitTime = 0 : void 0
                    }, i.send("undefined" != typeof ArrayBuffer && null !== ArrayBuffer ? n ? t : t.buffer : t);
                    if ("undefined" != typeof XDomainRequest)return i = new XDomainRequest, "http:" === document.location.protocol && (a = a.replace("https://", "http://")), i.open("POST", a + "?stm=" + +Date.now()), i.onload = function (t) {
                        return function () {
                ...
                } else if ("http:" === document.location.protocol && (a = a.replace("https://", "http://")), o = a + "?data=" + t + "&stm=" + +Date.now(), o.length <= 2036)return this.imgSend(o)
            ...
            return t.prototype.scheme = "https://", t.prototype.host = "api.growingio.com", t.prototype.circleHost = ("https:" === document.location.protocol ? "https://" : "http://") + "www.growingio.com", t.prototype.endpoint = "/events", t.prototype.properties = {
                ...
                var e, r;
                window.vds = {origin: this.circleHost};
    ...
    }, {"./guid": 5, "./info": 6, "./server_imp_setting": 9, "./utils": 12, lzstring: 15}],
    12: [function (t, e, r) {
        var n;
        n = {
    ...
    16: [function (t, e, r) {
        ...
        var n = {
            ...
            desc: 1,
            title: 1
        }, i = ["TR", "LI", "DL"], o = /^(clear|clearfix|active|hover|enabled|hidden|display|focus|disabled|ng-|growing-)/, a = ["button", "submit"], s = ["I", "SPAN", "EM"], u = ["A", "BUTTON"], d = function () {
            function t(t, e, r) {
                var n = this;
            ...
            return t.prototype.disconnect = function () {
                ...
                if (void 0 === e) {
                    ...
                    for (var d = t.parentElement; d && "BODY" !== d.tagName && "HTML" !== d.tagName;) {
                        var c = "/" + d.tagName.toLowerCase(), h = d.getAttribute("id");
                        if (h && null === h.match(/^[0-9]/) && (c += "#" + h), d.hasAttribute("class"))for (var l = d.getAttribute("class").trim().split(/\s+/).sort(), f = 0; f < l.length; f++)l[f].length > 0 && null === o.exec(l[f]) && (c += "." + l[f]);
                        e = c + e, d = d.parentElement
                    }
                }
                ...
                switch (1 === p.nodeType && -1 !== u.indexOf(t.tagName) && (p.dom = t), p.nodeType) {
                    ...
                    case 1:
                        ...
                        var m = t;
                        if (p.tagName = m.tagName, p.attributes = {any: m.hasAttributes()}, e += m.tagName.toLowerCase(), m.hasAttribute("id") && null === m.getAttribute("id").match(/^[0-9]/) && (e += "#" + m.getAttribute("id")), "INPUT" == m.tagName && m.hasAttribute("name"))e += "." + m.getAttribute("name"); else if (m.hasAttribute("class")) {
                        ...
                        if (e += "/", m.childNodes.length > 0) {
                            if (p.childNodes = [], m.hasAttribute("growing-ignore") || m.hasAttribute("data-growing-ignore"))return null;
                            for (var y = 0, O = -1 !== u.indexOf(m.tagName), C = m.firstChild; C; C = C.nextSibling)if (1 !== C.nodeType || !C.hasAttribute("growing-ignore") && !C.hasAttribute("data-growing-ignore"))if (O && -1 !== s.indexOf(C.tagName))b = !1; else {
                                -1 !== i.indexOf(C.tagName) && (y += 1);
                                var N;
                                if (N = y > 0 ? this.serializeNode(C, e, y) : this.serializeNode(C, e, r), null === N)3 != C.nodeType && (b = !1); else if ("undefined" != typeof N.childNodes) {
                                    b = !1, w = !0;
                                    for (var x = 0; x < N.childNodes.length; x++)if (N.childNodes[x].tagName) {
                                        w = !1;
                                        break
                                    }
                                    w && (y > 0 ? N.idx = y : r && (N.idx = r)), p.childNodes.push(N)
                                } else {
                                    if ((0 === m.offsetWidth || 0 === m.offsetHeight) && "A" !== m.tagName && "BUTTON" !== m.tagName)return null;
                                    N.leaf && (r && (N.idx = r), p.childNodes.push(N))
                                }
                            }
                        } else p.childNodes = [];
                        if (b)if (p.leaf = !0, "IMG" === m.tagName) {
                            if (m.src && -1 === m.src.indexOf("data:image") && (p.attributes.href = m.src), m.alt)p.text = m.alt; else if (p.attributes.href) {
                                var S = p.attributes.href.split("?")[0];
                                if (S) {
                                    var I = S.split("/");
                                    I.length > 0 && (p.text = I[I.length - 1])
                                }
                            }
                        } else if ("INPUT" === m.tagName && -1 !== a.indexOf(m.type))p.text = m.value; else {
                            var E = m.textContent.trim();
                            if (0 === E.length && "I" !== m.tagName && "A" !== m.tagName) {
                    ...
                    if (t && 1 !== n[t.tagName]) {
                        ...
                        if (e && !u[s.nodeId(e)] && "undefined" != typeof e.getAttribute) {
                            ...
                            if (!r || -1 === r.toLowerCase().indexOf("clock") && -1 === r.toLowerCase().indexOf("countdown") && -1 === r.toLowerCase().indexOf("time"))if (!i || -1 === i.toLowerCase().indexOf("clock") && -1 === i.toLowerCase().indexOf("countdown") && -1 === i.toLowerCase().indexOf("time"))if (e.getAttribute("data-countdown")); else if (o && -1 !== o.indexOf("daterangepicker")); else if (t.hasAttribute("growing-ignore") || t.hasAttribute("data-growing-ignore")); else {
                                for (; e && e !== document && "BODY" !== e.tagName && !e.hasAttribute("growing-ignore") && !e.hasAttribute("data-growing-ignore");)e = e.parentNode;
