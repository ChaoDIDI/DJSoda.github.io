!function t(e, r, n) {
    ...
    1: [function(t, e, r) {
        ...
        function l(t) {
            return E ? E : (E = c(k), E.oldValue = t, E)
        }
        function f() {
            k = E = void 0
        }
        ...
        if ("undefined" == typeof b) {
            var w = Object.defineProperty, y = Date.now()%1e9;
            b = function() {
        ...
        var O = new b, x = window.msSetImmediate;
        if (!x) {
            var C = [], N = String(Math.random());
            window.addEventListener("message", function(t) {
                ...
                C.push(t), window.postMessage(N, "*")
            }
        }
        var A=!1, S = [], I = 0;
        u.prototype = {
            observe: function(t, e) {
                if (t = i(t), !e.childList&&!e.attributes&&!e.characterData || e.attributeOldValue&&!e.attributes || e.attributeFilter && e.attributeFilter.length&&!e.attributes || e.characterDataOldValue&&!e.characterData)
            ...
            disconnect: function() {
                this.nodes_.forEach(function(t) {
                    for (var e = O.get(t), r = 0; r < e.length; r++) {
                        var n = e[r];
                        if (n.observer === this) {
    ...
    2: [function(t, e, r) {
        ...
        if (s = "undefined" != typeof WebKitMutationObserver ? WebKitMutationObserver : MutationObserver, void 0 === s)
        ...
        var h = function() {
            ...
            return t.prototype.processMutations = function() {
                ...
                if (!this.visited.has(t)) {
                    ...
                    if ((r && r.childList || void 0 == n) && (n = this.treeChanges.reachabilityChange(t)), 0 !== n) {
                        if (this.matchabilityChange(t), 1 === n)
                            this.entered.push(t);
                        else if (5 === n)
                            this.exited.push(t), this.ensureHasOldPreviousSiblingIfNeeded(t);
                        else if (2 === n) {
                            var i = 2;
                ...
                for (var o = {}, a = this.treeChanges.keys(), n = 0; n < a.length; n++) {
                    ...
                    if (u.attributes && 2 === this.treeChanges.reachabilityChange(s) && 2 === this.matchabilityChange(s))
                        for (var d = s, c = u.getAttributeNamesMutated(), h = 0; h < c.length; h++) {
                            var i = c[h];
                ...
                function r(t) {
                    ...
                    if (void 0 !== n)
                        return n;
                    for (n = a.oldPrevious.get(t); n && (a.removed.has(n) || e(n));)
                        n = r(n);
                ...
                function n(t) {
                    if (d.has(t))
                        return d.get(t);
                    for (var r = t.previousSibling; r && (a.added.has(r) || e(r));)
                        r = r.previousSibling;
                    return d.set(t, r), r
                }
            ...
            return Object.defineProperty(t.prototype, "caseInsensitiveTagName", {
                ...
                for (var a = 0; a < this.qualifiers.length; a++) {
                    ...
                    if (void 0 === u && (u = t.getAttribute(s.attrName)
                        ), !s.matches(u))return !1
                }
                return !0
                ...
                for (var i, o, a, s = [], u = /\s/, d = "Invalid or unsupported selector syntax.", c = 1, h = 2, l = 3, f = 4, p = 5, g = 6, w = 7, y = 8, O = 9, x = 10, C = 11, N = 12, A = 13, S = 14, I = c, k = 0; k < e.length;) {
                    var E = e[k++];
                    switch (I) {
                        case c:
                            if (E.match(v)) {
        ...
        }(), y = /^([a-zA-Z:_]+[a-zA-Z0-9_\-:\.]*)$/, O = function() {
            function t(e) {
                var r = this;
            ...
            return t.createObserverOptions = function(t) {
                ...
                return t.forEach(function(t) {
                    if (t.characterData)
                        return n.characterData=!0, void(n.characterDataOldValue=!0);
                    if (t.all)
                        return e(), n.characterData=!0, void(n.characterDataOldValue=!0);
                    if (t.attribute)
                ...
                for (var n = {
                    ...
                    if (s.all) {
                        ...
                        if (u.elementFilter = w.parseSelectors("*[" + u.attribute + "]"), Object.keys(s).length > 1)
                        ...
                        if (s.hasOwnProperty("elementAttributes") && (u.attributeList = o(s.elementAttributes), d--), d > 1)
                ...
                if (!t ||!t.length)
                    return [];
                for (var e = new p(this.root, t, this.elementFilter, this.calcReordered, this.options.oldPreviousSibling), r = [], n = 0; n < this.options.queries.length; n++)
            ...
            }, t.NodeMap = c, t.parseElementFilter = w.parseSelectors, t.optionKeys = {
                callback: !0,
                queries: !0,
                rootNode: !0,
    ...
    3: [function(t, e, r) {
        ...
        u = t("./utils"), a = u.detectIE() || 0 / 0, 9 > a ? t("json2") : (window.MutationObserver = t("mutation-observer"), o = t("tree-mirror")), s = t("./info"), u = t("./utils"), i = t("./messaging_observer"), n = function() {
            ...
            var e, r, n, a, c, h, l, f, p, g, v, m, b, w, y, O, x, C, N;
            return a = null, N = "0.57", y = 3, h = [], r = {}, c = {}, C = {
                tspan: 1,
                text: 1,
                g: 1,
                rect: 1,
                ...
                title: 1,
                use: 1
            }, f = {}, x = null, l = null, O = null, n=!0, e = ["TEXTAREA", "HTML", "BODY"], b = ["button", "submit"], w = ["A", "BUTTON", "INPUT", "IMG"], g = ["I", "SPAN", "EM", "svg"], m = ["A", "BUTTON"], v = m, p = ["radio", "checkbox"], t.prototype.setPageGroup = function(t) {
                return r.pg = t, this.pageLoaded&&+Date.now() - this.pageLoaded < 4e3 ? setTimeout(function(t) {
                    return function() {
                        var e;
                        return t.trackPageView(3), null != (e = t.messagingObserver) ? e.sendPageLoad(c) : void 0
                    }
                }(this), 10) : void 0
                        ...
                        initialize: function(t) {
                            return function(e) {
                                ...
                                for (a = {
                                    ...
                                    p: t.currentPath
                                }, t.currentQuery.length > 0 && (a.q = t.currentQuery), n = [], i = 0, o = e.length; o > i; i++)
                                    r = e[i], n = n.concat(t.getLeafNodes(r, e.length));
                            ...
                            return function(e, r, n, i) {
                                ...
                                if (r.length > 0&&!document.body.className.match(/\bvds-entrytext\b/)) {
                                    for (t.gruser.hasSid() || (t.pageLoaded =+ Date.now(), t.trackPageView(2)), u = {
                                        ...
                                        d: window.location.host || window.vds.accountId,
                                        p: t.currentPath
                                    }, t.currentQuery.length > 0 && (u.q = t.currentQuery), o = [], a = 0, s = r.length; s > a; a++)
                                        d = r[a], o = o.concat(t.getLeafNodes(d, d.length));
                                    if (u.e = o, o.length > 0)
                                        return h.push(u), 0 > y ? t.sendQueue() : (t.queueTimeout && clearTimeout(t.queueTimeout), t.queueTimeout = setTimeout(function() {
                                            return t.sendQueue()
                                        }, 3e3), t.checkingBlance())
                                }
                            }
                        }(this)
                    }, a = new o.Client(document.body, t)
            }, t.prototype.deregisterDomObserver = function() {
                return null != a ? a.disconnect() : void 0
            }, t.prototype.idle = function() {
                return this.lastSentTime = this.lastSentTime||+Date.now(), this.lastSentTime && ( + Date.now() - this.lastSentTime) / h.length > 300
            }, t.prototype.checkingBlance = function() {
                return this.idle() ? y -= 1 : void 0
            }, t.prototype.sendQueue = function() {
                return h.length > 0&&+Date.now() - this.lastActionTime < 3e5 && this.send(h), this.queueTimeout = null, this.lastSentTime =+ Date.now(), h = [], y = 3
            }, t.prototype.getLeafNodes = function(t, e) {
                var r, n, i, o, a, d, c, h, l, f;
                if (o = [], c=!0, t.leaf)
                    1 === t.nodeType && ((null != (h = t.attributes) ? h.href : void 0) || null != t.text || null != t.obj) && (d = this.nodeMessage(t, !0), e > 1 && (d.idx = t.idx), o.push(d));
                else if (0 === t.childNodes.length&&-1 === u.indexOf(w, t.tagName));
                else {
                    for (l = t.childNodes, i = 0, a = l.length; a > i; i++)
                        r = l[i], r.leaf || (c=!1), o = o.concat(this.getLeafNodes(r, t.childNodes.length));
                    c && ((null != (f = t.attributes) ? f.any : void 0) || t.text) && (t.text || (n = t.dom, t.text = n ? s.containerElemContent(n) : u.parentOfLeafText(t)),
                        d = this.nodeMessage(t, !1), o.push(d))
                }
                return o
                ...
                return n = {
                    x: t.path
                }, n.v = t.text, "A" === t.tagName && 0 === (null != (i = t.text) ? i.length : void 0) && (n.v = void 0), (null != (o = t.text) ? o.length : void 0) > 50 && (n.v = "A" === t.tagName ? t.text.slice(0, 30) : void 0), (r = t.attributes) && r.href && 0 !== r.href.indexOf("javascript") && (n.h = u.normalizePath(r.href.slice(0, 320)), delete t.attributes.href), t.idx && (n.idx = t.idx), t.obj && (n.obj = t.obj), n
            }, t.prototype.registerEventListener = function() {
                var t, r, i, o, a, d, c, h, p, m;
                d = {
                    click: "clck",
                    change: "chng",
                    submit: "sbmt"
                    ...
                    return t.which > 1 || (O =+ Date.now(), l === O) ? void 0 : (l = O, f = {
                        time: O,
                    ...
                    var e;
                    return e = {
                        adx: Math.abs(c("x", t) - f.x),
                        ady: Math.abs(c("y", t) - f.y)
                    }, e.adx > 10 || e.ady > 10 ? clearTimeout(x) : void 0
                }, m = function(t) {
                    var e;
                    return e =+ Date.now() - f.time, 1e3 > e ? clearTimeout(x) : void 0
                }, c = function(t, e) {
                    var r;
                    return r = n ? e.touches[0] : e, r["page" + t.toUpperCase()]
                }, i = function() {
                    var t, e, i, o, a, s, u, d, c, l, f, g, v, b;
                    b = navigator.userAgent, o = /chrome/i.exec(b), i = /android/i.exec(b), n = "ontouchstart"in window&&!(o&&!i), g = n ? ["touchstart"] : ["mousedown"], v = n ? ["touchend", "touchcancel"] : ["mouseup", "mouseleave"], l = n ? ["touchmove"] : ["mousemove"];
                    for (e = 0, u = g.length; u > e; e++)
                        t = g[e], r(document, t, p);
                    for (a = 0, d = l.length; d > a; a++)
                        t = l[a], r(document, t, h);
                    for (f = [], s = 0, c = v.length; c > s; s++)
                        t = v[s], f.push(r(document, t, m));
                    return f
                }, a = function(t) {
                    return function(r) {
                        var n, i, o, a, c;
                        if (!document.body.className.match(/\bvds-entrytext\b/)) {
                            for (t.lastActionTime =+ Date.now(), c = r.target || r.srcElement; c && 1 === C[c.tagName] && c.parentNode;)
                                c = c.parentNode;
                            if (n = s.path(c, !0), n.isIgnore)
                                return;
                            if (a = c.tagName, "click" === r.type) {
                                if ( - 1 !== u.indexOf(e, a))
                                    return;
                                if ("INPUT" === a&&-1 === u.indexOf(b, c.type))
                                    return;
                                if ( - 1 === u.indexOf(w, a)&&!s.depthInside(c, 4))
                                    return
                            }
                            return t.gruser.hasSid() || (t.pageLoaded =+ Date.now(), t.trackPageView(2)), o = {}, o.u = t.gruser.vid(), o.s = t.gruser.sid(), o.t = d[r.type], o.tm =+ Date.now(), o.ptm = t.pageLoaded, o.d = window.location.host || window.vds.accountId, o.p = t.currentPath, t.currentQuery.length > 0 && (o.q = t.currentQuery), i = t.compute(r.type, c), i.x = n.xpath, n.obj && (i.obj = n.obj), n.idx ? i.idx = n.idx : ( - 1 !== i.x.indexOf("/dl")||-1 !== i.x.indexOf("/tr")||-1 !== i.x.indexOf("/li")) && (i.idx = s.index(c)), o.e = 0 === n.containerMessage.length ? [i] : - 1 !== u.indexOf(v, n.pnode.tagName) && s.onlyContainsChildren(n.pnode, g) ? [n.containerMessage] : [i].concat(n.containerMessage), t.send([o])
                        }
                    }
                }(this);
                for (o in d)
                ...
                for (t in window.grcs)
                    e[t] = window.grcs[t];
                return e
            }, t.prototype.trackPageView = function(t) {
                var e, n, i;
                null == t && (t = 0), n = [], 3 !== t && n.push(this.visitMessage()), null == this.pageLoaded && (this.pageLoaded =+ Date.now()), 2 === t && (r = c), i = {
                    u: this.gruser.vid(),
                    s: this.gruser.sid(),
                ...
                if (r.pg)
                    ...
                    c = {};
                return r = {}, t > 0 && (i.fl = t), n.push(i), this.send(n, "pv"), this.lastActionTime =+ Date.now()
                ...
                for (p in n)
                    Array.isArray(n[p]) ? i.push(p) : v[p] = n[p];
                if (0 === i.length)
                    h.e = n, c.push(h);
                    ...
                    for (g = n[i[0]], a = 0, u = g.length; u > a; a++) {
                        if (o = g[a], "object" == typeof o) {
                            ...
                            f = Object.assign({}, v), f[i[0]] = o, l = Object.assign({}, h), l.e = f;
                        c.push(l)
                    } else {
                    for (s = 0, d = i.length; d > s; s++)
                        o = i[s], v[o] = n[o].join("##");
                    h.e = v, c.push(h)
                }
                return this.send(c, r)
            }, t.prototype.compute = function(t, e) {
                var r, n, i, o, a, d, c, h, l, f, m, w, y, O, x, C, N;
                if (i = {}, C = e.tagName, "IMG" === C ? (null != (y = e.src) ? y.length : void 0) > 0&&-1 === e.src.indexOf("data:image") && (i.h = e.src) : u.hasAttr(e, "href") && (o = e.getAttribute("href"), o && 0 !== o.indexOf("javascript") && (i.h = u.normalizePath(o.slice(0, 320)))), u.hasAttr(e, "data-growing-title") && e.getAttribute("data-growing-title").length > 0)
                    i.v = e.getAttribute("data-growing-title");
                else if (u.hasAttr(e, "title") && e.getAttribute("title").length > 0)
                    i.v = e.getAttribute("title");
                else if ("click" === t)
                    if (s.isLeaf(e))
                        if ("IMG" === C)
                            e.alt ? i.v = e.alt : i.h && (c = i.h.split("?")[0], d = c.split("/"), d.length > 0 && (i.v = d[d.length - 1]));
                        else if ("INPUT" === C&&-1 !== u.indexOf(b, e.type))
                            i.v = e.value;
                        else if ("svg" === C)
                            for (O = e.childNodes, a = 0, f = O.length; f > a; a++)
                                r = O[a], 1 === r.nodeType && "use" === r.tagName && u.hasAttr(r, "xlink:href") && (i.v = r.getAttribute("xlink:href"));
                        else
                            N = "", null != e.textContent ? N = e.textContent.replace(/[\n \t]+/g, " ").trim() : null != e.innerText && (N = e.innerText.replace(/[\n \t]+/g, " ").trim()), N.length > 0 && (N.length < 50 ? i.v = N : "A" === C && (i.v = N.slice(0, 30)));
                    else
                        - 1 !== u.indexOf(v, C) ? (n = s.containerElemContent(e), s.isParentOfLeaf(e)&&!s.onlyContainsChildren(e, g) ? (w = u.parentOfLeafText(e), w === n ? i.v = n : (i.v = w, i.obj = n || "")) : i.v = n) : s.isParentOfLeaf(e) && (i.v = u.parentOfLeafText(e));
                else if ("change" === t)
                    "TEXTAREA" !== C && ("INPUT" === C && ( - 1 !== u.indexOf(p, e.type) || "password" !== e.type && (u.hasAttr(e, "growing-track") || u.hasAttr("data-growing-track"))) || "SELECT" === C) && (i.v = e.value);
                else if ("submit" === t)
                    for (x = e.getElementsByTagName("input"), l = 0, m = x.length; m > l; l++)
                        h = x[l], ("search" === h.type || "text" === h.type && ("q" === h.id||-1 !== h.id.indexOf("search")||-1 !== h.className.indexOf("search") || "q" === h.name||-1 !== h.name.indexOf("search"))) && (i.x = s.path(h).xpath, i.v = h.value.trim());
                return i
            }, t.prototype.registerCircleHandler = function() {
                var t, e;
                try {
                    if (window.self !== window.top && (e = null != window.self.name ? window.self.name : window.name, "grcw" === e))
                        return this.messagingObserver = new i, this.messagingObserver.sendPageLoad(c)
                } catch (r) {
                    t = r
                }
                ...
                var r, n, i;
                if (this.gruser = t, this.blind())
                    return void this.registerCircleHandler();
                if (this.send = e, this.currentPath = u.path(), this.currentQuery = u.query(), this.trackPageView(), document.addEventListener)
                    "interactive" === document.readyState || "complete" === document.readyState ? this.domLoadedHandler() : u.bind(document, "DOMContentLoaded", function(t) {
                        return function() {
    ...
    6: [function(t, e, r) {
        var n, i, o, a, s, u, d, c, h, l, f;
        u = t("./guid"), a = t("cookie"), f = t("./utils"), o = /(^| )(clear|clearfix|active|hover|enabled|hidden|display|focus|disabled|ng-|growing-)[^\. ]*/g, s = /\.?([a-zA-Z0-9\-]+\.[a-zA-Z]{2,6})$/, h = ["I", "SPAN", "EM", "svg"], i = function() {
            function t(t) {
                var e, r;
                this.node = t, this.name = t.tagName.toLowerCase(), f.hasAttr(t, "id") && null === t.getAttribute("id").match(/^[0-9]/) && (this.id = t.getAttribute("id")), this.isIgnore = f.hasAttr(t, "growing-ignore") || f.hasAttr(t, "data-growing-ignore"), f.hasAttr(t, "href") && (this.href = t.getAttribute("href")), f.hasAttr(t, "data-growing-info") && (this.grObj = t.getAttribute("data-growing-info")), f.hasAttr(t, "data-growing-idx") && (this.grIdx = parseInt(t.getAttribute("data-growing-idx"))), "input" === this.name && f.hasAttr(t, "name") && t.getAttribute("name") ? this.klass = [t.getAttribute("name")] : (e = null != (r = t.getAttribute("class")) ? r.replace(o, "").trim() : void 0, (null != e ? e.length : void 0) > 0 && (this.klass = e.split(/\s+/).sort()))
            }
            ...
            return t.prototype.cookieDomain = function() {
                ...
                if (!this.grCookieDomains)
                    try {
                        t = window.location.hostname.split("."), this.grCookieDomains = ["." + t.slice( - 2).join("."), "." + t.slice( - 3).join(".")]
                    } catch (e) {
        ...
        }(), c = ["TR", "LI", "DL"], l = ["A", "BUTTON"], d = {
            user: function() {
                return new n
            },
            path: function(t, e) {
                var r, n, o, a, s, u, d, c, h, p, g, v;
                if (null == e && (e=!1), a = "", h=!1, n = [], c=!1, d=!1, t === document)
                    return {
                        isIgnore: !0
                    };
                for (r = new i(t); "body" !== r.name && "html" !== r.name;) {
                    if (p = r.path(), r.isIgnore && (h=!0), !c && r.hasObj() && (c=!0, u = r.grObj), !d && r.hasIdx() && (d=!0, s = r.grIdx), e && "" !== a && ( - 1 !== f.indexOf(l, r.node.tagName) || r.isContainer()))
                        return o = this.path(r.node), n = {
                            x: o.xpath,
                            h: r.href,
                            v: this.containerElemContent(r.node)
                        }, v = {
                            xpath: n.x + a,
                            isIgnore: h || o.isIgnore,
                            pnode: r.node
                        }, d ? (n.idx = s, v.idx = s) : o.idx ? (n.idx = o.idx, v.idx = o.idx) : ( - 1 !== o.xpath.indexOf("/dl")||-1 !== o.xpath.indexOf("/tr")||-1 !== o.xpath.indexOf("/li")) && (n.idx = this.index(r.node)), c ? (n.obj = u, v.obj = u) : o.obj && (n.obj = o.obj, v.obj = o.obj), v.containerMessage = n, v;
                    if (a = p + a, g = r.node.parentNode, !g ||!g.tagName)
                        break;
                    r = new i(g)
                }
                return v = {
                    ...
                    containerMessage: n,
                    isIgnore: h
                }, c && (v.obj = u), d && (v.idx = s), v
            },
            index: function(t) {
                var e, r, n, i, o, a, s;
                for (o = t; o && "BODY" !== o.tagName&&-1 === f.indexOf(c, o.tagName);)
                    o = o.parentNode;
                if (o)
                    for (a = o.parentNode, r = 1, s = a.childNodes, e = 0, n = s.length; n > e; e++)
                        if (i = s[e], i.tagName === o.tagName) {
                            if (f.hasAttr(i, "data-growing-idx") && (r = parseInt(i.getAttribute("data-growing-idx"))), i === o)
                                return r;
                            r += 1
                        }
            },
            ...
            depthInside: function(t, e, r) {
                ...
                if (null == r && (r = 1), t.hasChildNodes()) {
                    ...
                    for (a = t.childNodes, n = 0, i = a.length; i > n; n++)
                        if (o = a[n], 1 === o.nodeType&&!d.depthInside(o, e, r + 1))
                            return !1
                }
                return e >= r
            },
            onlyContainsChildren: function(t, e) {
                ...
                for (o = t.children, n = 0, i = o.length; i > n; n++)
                    if (r = o[n], - 1 === f.indexOf(e, r.tagName))
                        return !1;
                return !0
            },
            containerElemContent: function(t) {
                ...
                if ("BUTTON" === t.tagName) {
                    if (t.name.length > 0)
                        return t.name;
                    if (d.onlyContainsChildren(t, h) && null != t.textContent && (e = t.textContent.replace(/[\n \t]+/g, " ").trim(), e.length > 0 && e.length < 50))
                        return e
                } else if ("A" === t.tagName) {
                    if (f.hasAttr(t, "data-growing-title") && t.getAttribute("data-growing-title").length > 0)
                        return t.getAttribute("data-growing-title");
                    if (f.hasAttr(t, "title") && t.title.length > 0)
                        return t.getAttribute("title");
                    if (d.onlyContainsChildren(t, h) && null != t.textContent) {
                        if (e = t.textContent.replace(/[\n \t]+/g, " ").trim(), e.length > 0 && e.length < 50)
                            return e
                    } else if (f.hasAttr(t, "href") && t.getAttribute("href").length > 0)
    ...
    7: [function(t, e, r) {
        var n, i, o, a, s, u, d, c, h, l, f = [].slice;
        if (t("./shim"), i = t("./tracker"), n = t("./dom_observer"), l = new i, u = new n, o = function() {
                var t, e, r;
                r = arguments[0], t = 2 <= arguments.length ? f.call(arguments, 1) : [];
                try {
                    if (null != l[r])
                        return l[r].apply(l, t);
                    if (null != u[r])
                        return u[r].apply(u, t)
                } catch (n) {
                    return e = n, console.error(e)
                }
            }, !window.vds ||!window.vds.origin) {
            for (null == window._vds && (window._vds = [["setAccountId", "22222-22222-22222-22222"]]), h = window._vds, d = 0, c = h.length; c > d; d++)
                a = h[d], o.apply(null, a);
            window._vds = {
                push: function() {
                ...
                clickOn: function() {
                    return u.clickOn.apply(u, arguments)
                },
                impOn: function() {
                    return u.impOn.apply(u, arguments)
                }
            }, s = function(t, e) {
    ...
    8: [function(t, e, r) {
        ...
        i = t("./utils"), n = function() {
            function t() {
                this.sendPageLoad = o(this.sendPageLoad, this), this.allowOrigin = window.vds.origin, this.bindEvents()
            }
            return t.prototype.bindEvents = function() {
                return i.bind(window, "message", function(t) {
                    return function(e) {
                        var r;
                        if (r = e.data, r.ai === window.vds.accountId && (e.origin === window.vds.origin||-1 !== i.indexOf(["www.growingio.com", "growingio.com"], e.origin.split("://")[1])))
                            switch (e.origin !== window.vds.origin && (window.vds.origin = e.origin), r.mode) {
                                case"load-plugin":
                                    return t.loadPlugin();
                                case"circle-mode":
    ...
    11: [function(t, e, r) {
        var n, i, o, a, s, u, d, c, h, l, f, p, g = [].indexOf || function(t) {
        ...
        u = t("./guid"), h = t("lzstring"), c = t("./info"), p = t("./utils"), o = t("./server_imp_setting"), d = p.detectIE() || 0 / 0, l = navigator.userAgent.match(/Chrom(e|ium)\/([0-9]+)\./), s = l ? parseInt(l[2], 10) : !1, s && 22 > s ? n=!1 : (n=!0, f = navigator.userAgent, g.call(window, "ArrayBufferView") >= 0 || ( - 1 !== f.indexOf("Android") ? n=!1 : - 1 !== f.indexOf("CPU OS ")?-1 !== f.indexOf("CPU OS 6_") ? n=!1 : - 1 !== f.indexOf("CPU OS 5_") ? n=!1 : - 1 !== f.indexOf("CPU OS 4_") ? n=!1 : - 1 !== f.indexOf("CPU OS 3_") && (n=!1) : - 1 !== f.indexOf("CPU iPhone OS ")?-1 !== f.indexOf("iPhone OS 6_") ? n=!1 : - 1 !== f.indexOf("iPhone OS 5_") ? n=!1 : - 1 !== f.indexOf("iPhone OS 4_") && (n=!1) : - 1 !== f.indexOf("Intel Mac OS X") && ( - 1 !== f.indexOf("Mac OS X 10_6") ? n=!1 : - 1 !== f.indexOf("Mac OS X 10_7") && (n=!1)))), i = function() {
            function t(t, e, r) {
                this.user = t, this.urlMap = e, this.callback = r, this.send = v(this.send, this)
            }
            var e, r;
            return e = [], r = [], t.prototype.connect = function() {
                ...
                null == e && (e = "action");
                try {
                    return r = "undefined" != typeof Uint8Array && null !== Uint8Array ? h.compressToUint8Array(JSON.stringify(t)) : window.XMLHttpRequest && 7 !== d ? h.compressToUTF16(JSON.stringify(t)) : h.compressToEncodedURIComponent(JSON.stringify(t)), this.sendRemote(r, e)
                } catch (i) {
                    n = i
                }
            }, t.prototype.sendRemote = function(t, e) {
                var i, o, a;
                if (a = this.urlMap[e], window.grWaitTime = Date.now() + 300, window.XMLHttpRequest && 7 !== d) {
                    if (i = new XMLHttpRequest, "withCredentials"in i)
                        return i.open("POST", a + "?stm=" + + Date.now(), !0), i.withCredentials=!0, i.onreadystatechange = function() {
                            return 4 === i.readyState ? window.grWaitTime = 0 : void 0
                        }, i.send("undefined" != typeof ArrayBuffer && null !== ArrayBuffer ? n ? t : t.buffer : t);
                    if ("undefined" != typeof XDomainRequest)
                        return i = new XDomainRequest, "http:" === document.location.protocol && (a = a.replace("https://", "http://")), i.open("POST", a + "?stm=" + + Date.now()), i.onload = function(t) {
                            return function() {
                                return t.removeXDR(i)
                            }
                ...
                } else if ("http:" === document.location.protocol && (a = a.replace("https://", "http://")), o = a + "?data=" + t + "&stm=" + + Date.now(), o.length <= 2036)
                    return this.imgSend(o)
            }, t.prototype.removeXDR = function(t) {
                var e;
                return e = p.indexOf(r, t), - 1 !== e && r.splice(e, 1), window.grWaitTime = 0
            }, t.prototype.imgSend = function(t) {
                var e;
                return e = document.createElement("img"), e.width = 1, e.height = 1, e.onload = e.onerror = e.onabort = function(t) {
                    return function() {
                        return e.onload = null, e.onerror = null, e.onabort = null, t.removeXDR(e)
                    }
                }(this), e.src = t, r.push(e)
            }, t
        }(), a = function() {
            function t() {
                window.grcs = {}, this.user = c.user()
            }
            return t.prototype.scheme = "https://", t.prototype.host = "api.growingio.com", t.prototype.circleHost = ("https:" === document.location.protocol ? "https://" : "http://") + "growingio.com", t.prototype.endpoint = "/events", t.prototype.properties = {
                imp: !0,
                hashtag: !1,
                touch: !1
                ...
                for (e in this.properties)
                    window.vds[e] = this.properties[e];
                return f = window.navigator.userAgent.toLowerCase(), f.match(/(bot|crawler|spider|scrapy|jiankongbao|slurp|transcoder)/i) && (window.vds.imp=!1, ( - 1 !== f.indexOf("baiduspider/")||-1 !== f.indexOf("googlebot")) && (n=!1)), window.vds.imp && o.initialize(), r = new i(this.user, this.getUrlMap(), t), this.setUid(), r.connect()
            }, t
        }(), e.exports = a
    }, {
        "./guid": 5,
        ...
        n = {
            ...
            parentOfLeafText: function(t) {
                ...
                for (a = t.childNodes, i = 0, o = a.length; o > i; i++)
                    e = a[i], 3 === e.nodeType && (null != e.textContent ? r = e.textContent.trim() : null != e.data && (r = e.data.trim()), r.length > 0 && (n += r + " "));
            ...
            sendRequest: function(t, e, r) {
                ...
                if (window.XMLHttpRequest) {
                    if (n = new XMLHttpRequest, "withCredentials"in n)
                        return n.open("GET", t, !0), n.withCredentials=!0, n.onreadystatechange = function() {
                            return 4 === n.readyState ? "function" == typeof e ? e(n) : void 0 : "function" == typeof r ? r(n) : void 0
                        }, n.send();
                    if ("undefined" != typeof XDomainRequest)
                        return n = new XDomainRequest, "http:" === document.location.protocol && (t = t.replace("https://", "http://")), n.open("GET", t), n.onload = function(t) {
                            return function() {
    ...
    13: [function(t, e, r) {
        var n = {
            ...
            keys: function() {
                for (var t = document.cookie.replace(/((?:^|\s*;)[^\=]+)(?=;|$)|^\s*|\s*(?:\=[^;]*)?(?:\1|$)/g, "").split(/\s*(?:\=[^;]*)?;\s*/), e = t.length, r = 0; e > r; r++)
            ...
            hasItem: n.hasItem,
            keys: n.keys,
            setItem: function(t, e, r, i, o, a) {
                for (var s = 0; s < o.length && (n.setItem(t, e, r, i, o[s], a), !n.getItem(t)); s++);
            }
        };
        e.exports = i
    }, {}
                    ...
                    case"object":
                        ...
                        if (rep && "object" == typeof rep)
                            for (o = rep.length, r = 0; o > r; r += 1)
                                "string" == typeof rep[r] && (n = rep[r], i = str(n, u), i && a.push(quote(n) + (gap ? ": " : ":") + i));
                        else
                            for (n in u)
                                Object.prototype.hasOwnProperty.call(u, n) && (i = str(n, u), i && a.push(quote(n) + (gap ? ": " : ":") + i));
                        return i = 0 === a.length ? "{}" : gap ? "{\n" + gap + a.join(",\n" + gap) + "\n" + s + "}" : "{" + a.join(",") + "}", gap = s, i
                }
            }
            ...
            "function" != typeof JSON.stringify && (meta = {
                ...
                function walk(t, e) {
                    ...
                    if (i && "object" == typeof i)
                        for (r in i)
                            Object.prototype.hasOwnProperty.call(i, r) && (n = walk(i, r), void 0 !== n ? i[r] = n : delete i[r]);
            ...
            var t = String.fromCharCode, e = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+-$", r = {
                ...
                _compress: function(t, e, r) {
                    ...
                    for (o = 0; o < t.length; o += 1)
                        if (u = t.charAt(o), Object.prototype.hasOwnProperty.call(a, u) || (a[u] = l++, s[u]=!0), d = c + u, Object.prototype.hasOwnProperty.call(a, d))
                            c = d;
                        else {
                            if (Object.prototype.hasOwnProperty.call(s, c)) {
                                if (c.charCodeAt(0) < 256) {
                                    for (n = 0; f > n; n++)
                                        g<<=1, v == e - 1 ? (v = 0, p.push(r(g)), g = 0) : v++;
                                    for (i = c.charCodeAt(0), n = 0; 8 > n; n++)
                                        g = g<<1 | 1 & i, v == e - 1 ? (v = 0, p.push(r(g)), g = 0) : v++, i>>=1
                                } else {
                                    for (i = 1, n = 0; f > n; n++)
                                        g = g<<1 | i, v == e - 1 ? (v = 0, p.push(r(g)), g = 0) : v++, i = 0;
                                    for (i = c.charCodeAt(0), n = 0; 16 > n; n++)
                                        g = g<<1 | 1 & i, v == e - 1 ? (v = 0, p.push(r(g)), g = 0) : v++, i>>=1
                                }
                ...
                if (void 0 === e) {
                    ...
                    for (var c = t.parentElement; c && "BODY" !== c.tagName && "HTML" !== c.tagName;) {
                        ...
                        if (l && null === l.match(/^[0-9]/) && (h += "#" + l), c.hasAttribute("class"))
                            for (var f = c.getAttribute("class").trim().split(/\s+/).sort(), p = 0; p < f.length; p++)
                                f[p].length > 0 && null === o.exec(f[p]) && (h += "." + f[p]);
                ...
                switch (1 === g.nodeType&&-1 !== u.indexOf(t.tagName) && (g.dom = t), g.nodeType) {
                    ...
                    case 1:
                        ...
                        if ("block" !== m && "inline" !== m && ("none" === m || "none" === window.getComputedStyle(t).display) && "A" !== t.tagName && null === t.querySelector("a"))
                            return null;
                        var b = t;
                        if (g.tagName = b.tagName, g.attributes = {
                                any: b.hasAttributes()
                            }, e += b.tagName.toLowerCase(), b.hasAttribute("id") && null === b.getAttribute("id").match(/^[0-9]/) && (e += "#" + b.getAttribute("id")), "INPUT" == b.tagName && b.hasAttribute("name"))
                            e += "." + b.getAttribute("name");
                        else if (b.hasAttribute("class")) {
                            f = b.getAttribute("class").trim().split(/\s+/).sort();
                            for (var p = 0; p < f.length; p++)
                                f[p].length > 0 && null === o.exec(f[p]) && (e += "." + f[p])
                        }
                        b.hasAttribute("href") && (g.attributes.href = b.getAttribute("href"));
                        var w, y=!0;
                        if (e += "/", b.childNodes.length > 0) {
                            if (g.childNodes = [], b.hasAttribute("growing-ignore") || b.hasAttribute("data-growing-ignore"))
                                return null;
                            var O, x, C = 0, N =- 1 !== u.indexOf(b.tagName);
                            if (N)
                                for (var A = b.firstChild; A; A = A.nextSibling)
                                    if (1 === A.nodeType&&-1 === s.indexOf(A.tagName)) {
                                        N=!1;
                                        break
                                    }
                            for (var S = b.firstChild; S; S = S.nextSibling) {
                                if (O = b.hasAttribute("data-growing-info") ? b.getAttribute("data-growing-info") : null, x = b.hasAttribute("data-growing-idx") ? parseInt(b.getAttribute("data-growing-idx")) : - 1, 1 === S.nodeType) {
                                    if (1 === n[S.tagName])
                                        continue;
                                    if (S.hasAttribute("growing-ignore") || S.hasAttribute("data-growing-ignore"))
                                        continue;
                                    if (N&&-1 !== s.indexOf(S.tagName)) {
                                        y=!1;
                                        continue
                                    }
                                    - 1 !== i.indexOf(S.tagName) && (C += 1, x = C), S.hasAttribute("data-growing-idx") && (C = parseInt(S.getAttribute("data-growing-idx")), x = C), S.hasAttribute("data-growing-info") && (O = S.getAttribute("data-growing-info"))
                                }
                                var I = this.serializeNode(S, e, C > 0 && x > 0 ? C : r, O || d);
                                if (null === I)
                                    3 != S.nodeType && (y=!1);
                                else if ("undefined" != typeof I.childNodes) {
                                    y=!1, w=!0;
                                    for (var k = 0; k < I.childNodes.length; k++)
                                        if (I.childNodes[k].tagName) {
                                            w=!1;
                                            break
                                        }
                                    C > 0 && x > 0 ? I.idx = C : r && (I.idx = r), O ? I.obj = O : d && (I.obj = d), g.childNodes.push(I)
                                } else {
                                    if ((0 === b.offsetWidth || 0 === b.offsetHeight) && "A" !== b.tagName && "BUTTON" !== b.tagName)
                                        return null;
                            ...
                            g.childNodes = [];
                        if (y)
                            if (g.leaf=!0, "IMG" === b.tagName && (delete g.attributes.href, b.src&&-1 === b.src.indexOf("data:image") && (g.attributes.href = b.src)), b.hasAttribute("data-growing-title") && b.getAttribute("data-growing-title").length > 0)
                                g.text = b.getAttribute("data-growing-title");
                            else if (b.hasAttribute("title") && b.getAttribute("title").length > 0)
                                g.text = b.getAttribute("title");
                            else if ("IMG" === b.tagName) {
                                if (b.alt)
                                    g.text = b.alt;
                                else if (g.attributes.href) {
                                    var E = g.attributes.href.split("?")[0];
                                    if (E) {
                                        var D = E.split("/");
                                        D.length > 0 && (g.text = D[D.length - 1])
                                    }
                                }
                            } else if ("INPUT" === b.tagName&&-1 !== a.indexOf(b.type))
                                g.text = b.value;
                            else if ("svg" === b.tagName) {
                                for (var T = b.firstChild; T; T = T.nextSibling)
                                    if ("use" === T.tagName && T.getAttribute("xlink:href")) {
                                        g.text = T.getAttribute("xlink:href");
                                        break
                                    }
                            } else {
                                var _ = b.textContent.trim();
                                if (0 === _.length && "I" !== b.tagName && "A" !== b.tagName)
                                    return null;
                                g.text = _
                            } else
                            b.hasAttribute("data-growing-title") && b.getAttribute("data-growing-title").length > 0 ? g.text = b.getAttribute("data-growing-title") : b.hasAttribute("title") && b.getAttribute("title").length > 0 && (g.text = b.getAttribute("title")), b.hasAttribute("data-growing-idx") && (g.idx = parseInt(b.getAttribute("data-growing-idx"))), b.hasAttribute("data-growing-info") && (g.obj = b.getAttribute("data-growing-info"));
                        g.path = e.slice(0, - 1)
                }
                return g
                            ...
                            if (!r||-1 === r.toLowerCase().indexOf("clock")&&-1 === r.toLowerCase().indexOf("countdown")&&-1 === r.toLowerCase().indexOf("time"))
                                if (!i||-1 === i.toLowerCase().indexOf("clock")&&-1 === i.toLowerCase().indexOf("countdown")&&-1 === i.toLowerCase().indexOf("time"))
                                    if (e.getAttribute("data-countdown"));
                                        ...
                                        for (; e && e !== document && "BODY" !== e.tagName&&!e.hasAttribute("growing-ignore")&&!e.hasAttribute("data-growing-ignore");)
                                            e = e.parentNode;
